...
for friend in friendList:
    ...
    print(randomBless())
    # okWord = u'🎉🎉[红包][红包]亲爱的%s，L给你带来了新年祝福~  ' + randomBless() + "\nMade by Lance[猪头][猪头][红包][红包]🎉🎉"
    okWord = u'%s不好意思'
    print(okWord % (friend['DisplayName'] or friend['NickName']),
          friend['UserName'])
    itchat.send(okWord % (friend['RemarkName'] or friend['NickName'] or friend['DisplayName']), friend['UserName'])
